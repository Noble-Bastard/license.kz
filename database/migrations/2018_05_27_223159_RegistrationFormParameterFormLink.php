...
class RegistrationFormParameterFormLink extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('registration_form_parameter', function ($table) {
            $table->foreign('registration_form_id','registration_form_parameter_form_fk')->references('id')->on('registration_form');
        });
