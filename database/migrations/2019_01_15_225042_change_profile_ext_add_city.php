...
class ChangeProfileExtAddCity extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        select
            ...
            p.company_profile_address_id,
            cpa_c.value company_profile_address_name,
            p.city_id,
            c.value city_name
        from profile p
            left join users u
            ...
            left join company_profile_address cpa
                on p.company_profile_address_id = cpa.id
