...
class ChangeServiceExecutiveAgencyIssuingAuthorityExtRequirements extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('service', function (Blueprint $table){
            //$table->dropColumn('executive_agency');
            $table->text('additional_approvals');
...
//        Schema::create('executive_agency', function(Blueprint $table){
...
//        });
//
//        Schema::create('additional_approvals_map', function(Blueprint $table){
//           $table->increments('id');
//           $table->unsignedSmallInteger('additional_approvals_id');
//           $table->unsignedInteger('service_id');
//
//            $table->foreign('additional_approvals_id', 'aam_additional_approvals_fk')->references('id')->on('additional_approvals')->onUpdate('NO ACTION')->onDelete('NO ACTION');
//            $table->foreign('service_id', 'aam_service_fk')->references('id')->on('service')->onUpdate('NO ACTION')->onDelete('NO ACTION');
//        });
//
//        Schema::table('service', function (Blueprint $table){
//            $table->unsignedSmallInteger('executive_agency_id')->nullable();
//
//            $table->foreign('executive_agency_id', 'service_executive_agency_fk')->references('id')->on('executive_agency')->onUpdate('NO ACTION')->onDelete('NO ACTION');
//        });
    }
