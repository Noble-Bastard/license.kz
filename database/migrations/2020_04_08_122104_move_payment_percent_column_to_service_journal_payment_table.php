...
class MovePaymentPercentColumnToServiceJournalPaymentTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('service_journal', function (Blueprint $table) {
            $table->dropColumn('prepayment_percent');
        });
        ...
        DB::unprepared("
            update service_journal_payment
            set
                prepayment_percent = 0.7
            where prepayment_percent is null;
        ");
    }
