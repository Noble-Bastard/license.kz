        ...
        <div class="col-12">
            <div class="card">
                <div class="title-main">
                    {{trans.get('messages.career_form.list')}}
                        ...
                        <div class="card-body">
                            <div>
                                <table id="users" class="table table-striped table-responsive-sm col-12">
                                    <thead>
                                    <tr>
                                        <th>{{trans.get('messages.career_form.fio')}}</th>
                                        <th>{{trans.get('messages.career_form.desired_position')}}</th>
                                        <th>{{trans.get('messages.career_form.dob')}}</th>
...
<script>
    export default {
        ...
        methods: {
            ...
            showCard(employeeId) {
                window.open('/career/show/' + employeeId,'_blank');
            },
