<template>
    <div>
                    ...
                    <table class="table table-striped table-responsive-sm col-12">
                        <thead>
                            <tr>
                                ...
                                <th class="w-55">{{trans.get('messages.all.client_fullname')}}</th>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item setServiceJournalStatus"
                                                @click="showChangeStatusModal(serviceJournal.id)">
                                                {{trans.get('messages.head.services.action.set_service_journal_status')}}
                                            </a>
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" :id="setServiceJournalStatusModalName">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" @change="form.errors.clear($event.target.name)"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form-group
                                        :p-caption="trans.get('messages.all.service_number')"
                                        p-field-name="serviceName"
                                        :p-form="form"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form-group
                                        :p-caption="trans.get('messages.sale_manager.client')"
                                        p-field-name="clientName"
                                        :p-form="form"
                                        :p-type="componentType.Input"
                                        p-input-type="text"
                                        :p-read-only="true"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form-group
                                        :p-caption="trans.get('messages.all.service_status')"
                                        p-field-name="serviceJournalStatusId"
                                        :p-form="form"
                                        :p-type="componentType.Select2"
                                        :p-dict-list="pServiceStatuses"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" @click="changeStatus()" :disabled="form.errorsOrSend()" class="btn btn-primary">
...
<script>
    ...
    export default {
        ...
        name: "HeadAccountantServiceJournalList",
        data() {
            return {
                baseUrl: '/head/vue/services',
                setStatusUrl: '/head/services/setServiceJournalStatus',
                serviceJournalList: [],
                ...
                defaultEntity: {
                    ...
                    serviceJournalStatusId: null,
                    serviceName: '',
                    clientName: '',
                    prevServiceJournalStatusId: null,
                },
        ...
        computed: {
            setServiceJournalStatusModalName: function() {
                return 'set-service-journal-status-modal';
            },
        },
        methods: {
            getEntityList() {
            ...
            showChangeStatusModal(serviceJournalId) {
                let serviceJournal = this.getServiceJournal(serviceJournalId);
                this.form = new Form(this.defaultEntity);
                this.form.serviceJournalId = serviceJournalId;
                this.form.serviceJournalStatusId = serviceJournal.service_status_id;
                this.form.prevServiceJournalStatusId = serviceJournal.service_status_id;
                this.form.serviceName = serviceJournal.service_no;
                this.form.clientName = serviceJournal.client_full_name;

                this.selectedServiceJournalDescription = this.trans.get('messages.head.services.action.set_service_journal_status')
                    + ' ' + serviceJournal.service_no;

                $('#' + this.setServiceJournalStatusModalName).modal('show');
            },
            changeStatus() {
                let url = this.setStatusUrl;
                let isStatusChanged = this.form.prevServiceJournalStatusId !==  this.form.serviceJournalStatusId;
                ...
                this.form.post(url)
                    .then(response => {
                        ...
                        $('#' + this.setServiceJournalStatusModalName).modal('hide');
                    });
