      ...
      <div class="row">
        <div class="col-12">
          <div class="title-main">
            {{ trans.get('messages.admin.dictionary.serviceRequiredDocument.title') }}
          </div>
        </div>
        <div class="col-12">
          <div class="card">
              ...
              <div class="row">
                <div class="col-12 mt-3">
                  <table class="table table-striped table-responsive-sm col-12">
                    <thead>
                    <tr>
                      <th>{{ trans.get('messages.admin.dictionary.serviceRequiredDocument.description') }}</th>
                      <th>{{ trans.get('messages.admin.dictionary.serviceRequiredDocument.description_en') }}</th>
                      <th></th>
                    </tr>
                    </thead>
                    <tbody>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" @change="form.errors.clear($event.target.name)"
            ...
            <multi-lang-form-group
                :p-caption="trans.get('messages.admin.dictionary.serviceRequiredDocument.description')"
...
<script>
export default {
  name: "ServiceRequiredDocumentComponent",
  data() {
    return {
      url: '/admin/vue/dictionary/serviceRequiredDocument',
      entityList: {},
      defaultEntity: {
        id: null,
        description: '',
