      ...
      <div class="row">
        <div class="col-12">
          <div class="title-main">
            {{ trans.get('messages.admin.dictionary.licenseType.title') }}
          </div>
        </div>
        <div class="col-12">
              ...
              <div class="row">
                <div class="col-12 mt-3">
                  <table class="table table-striped table-responsive-sm col-12">
                    <thead>
                    <tr>
                      <th>{{ trans.get('messages.admin.dictionary.licenseType.name') }}</th>
                      <th>{{ trans.get('messages.admin.dictionary.licenseType.name_en') }}</th>
                      <th></th>
                    </tr>
                    </thead>
                    <tbody>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" @change="form.errors.clear($event.target.name)"
            ...
            <div class="form-group">
              <label for="name">{{ trans.get('messages.admin.dictionary.licenseType.name') }}</label>
            ...
            <div class="form-group">
              <label for="name_en">{{ trans.get('messages.admin.dictionary.licenseType.name_en') }}</label>
...
<script>
export default {
  name: "LicenseTypeComponent",
  data() {
    return {
      url: '/admin/vue/dictionary/licenseType',
      entityList: {},
      defaultEntity: {
        id: null,
        name: '',
