      ...
      <div class="row">
        <div class="col-12">
          <div class="title-main">
            {{ trans.get('messages.admin.dictionary.serviceAdditionalRequirementsType.title') }}
          </div>
        </div>
        <div class="col-12">
          <div class="card">
              ...
              <div class="row">
                <div class="col-12 mt-3">
                  <table class="table table-striped table-responsive-sm col-12">
                    <thead>
                    <tr>
                      <th>{{ trans.get('messages.admin.dictionary.serviceAdditionalRequirementsType.name') }}</th>
                      <th>{{ trans.get('messages.admin.dictionary.serviceAdditionalRequirementsType.name_en') }}</th>
                      <th></th>
                    </tr>
                    </thead>
                    <tbody>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" @change="form.errors.clear($event.target.name)"
            ...
            <multi-lang-form-group
                :p-caption="trans.get('messages.admin.dictionary.serviceAdditionalRequirementsType.name')"
                p-field-name="name"
                :p-form="form"
...
<script>
export default {
  name: "ServiceAdditionalRequirementsTypeComponent",
  data() {
    return {
      url: '/admin/vue/dictionary/serviceAdditionalRequirementsType',
      entityList: {},
      defaultEntity: {
        id: null,
        name: '',
