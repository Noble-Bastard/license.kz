<template>
    <div>
        <div class="title-main">
            {{trans.get('messages.admin.registrationFormTemplate.optionsetType.title')}}
                    ...
                    <div class="col-12">
                        ...
                        <div>
                            <table id="optionsetList" class="table table-striped table-responsive-sm col-12">
                                <thead>
                                <tr>
                                    <th>{{trans.get('messages.admin.registrationFormTemplate.optionsetType.id')}}</th>
                                    <th>{{trans.get('messages.admin.registrationFormTemplate.optionsetType.name')}}</th>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   @click="editOptionsetValues(entity.id, index)">{{trans.get('messages.admin.registrationFormTemplate.optionsetType.editValues')}}</a>
                                                <a class="dropdown-item"
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit-optionset-value-template" aria-hidden="true">
            <div class="modal-dialog modal-full" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" v-text="trans.get('messages.admin.registrationFormTemplate.optionsetValueTemplate.title') + ': ' + form.name"></h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <registration-form-template-optionset-value-template-list :key="optionsetValueTemplateListComponentKey" :initial-optionset-type-id="form.id"></registration-form-template-optionset-value-template-list>
...
<script>
    ...
    export default {
        name: "OptionsetTypeListComponent",
        data() {
            return {
                url: '/admin/vue/registration_form_template/optionset_type',
                entityList: {},
                currentPage: 1,
                defaultEntity: {
                    id: null,
