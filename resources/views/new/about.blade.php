                ...
                <div class="about-us__near-footer__container z-index-primary">
                    ...
                    <div class="about-us__near-footer__container__join">
                        ...
                        <div class="text-center ">
                            <a class="btn btn-primary about-us__near-footer__container__join__button" href="{{route('index') . '#listOfIndustries'}}">
                                @lang('messages.layouts.become_client')
                            </a>
                            <a class="btn btn-primary about-us__near-footer__container__join__button" href="{{route('partner')}}">
