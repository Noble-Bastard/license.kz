...
<div id="resetPasswordModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 999999; width: 100vw; height: 100vh; overflow: auto; background: rgba(0,0,0,0.4); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);" onclick="if(event.target === this) closeResetPasswordModal();">
    ...
    <div style="display: flex; align-items: center; justify-content: center; min-height: 100%; padding: 20px;">
        ...
        <div class="bg-white rounded-lg border shadow-xl relative" style="border-color: #E8E8E8;">
            ...
            <button onclick="closeResetPasswordModal()" style="position: absolute; top: 5px; right: -55px; z-index: 1000000; width: 40px; height: 40px; border-radius: 50%; background-color: #FFFFFF; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 8px rgba(0,0,0,0.15); transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
            ...
            <div style="padding: 1.5rem;">
                ...
                <form id="resetPasswordForm" class="form-horizontal" method="POST" action="{{ route('password.request') }}">
                    @csrf
                    <input type="hidden" name="token" value="{{ $token ?? '' }}">
                    
                    <!-- Email Field -->
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        <label for="email" style="display: block; color: #191E1D; font-size: 0.875rem; font-weight: 500; margin-bottom: 0.5rem; text-align: left;">
                            Электронная почта
                        </label>
                        <input type="email" 
                               id="email"
                               ...
                               style="border-color: #D9D9D9; color: #191E1D; background-color: #F5F5F5; cursor: not-allowed;">
                        @if ($errors->has('email'))
                    ...
                    <!-- Password Field -->
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        <label for="password" style="display: block; color: #191E1D; font-size: 0.875rem; font-weight: 500; margin-bottom: 0.5rem; text-align: left;">
                            Пароль
                        </label>
                        <input type="password" 
                               id="password"
                    ...
                    <div class="form-group" style="margin-bottom: 1.5rem;">
                        <label for="password_confirmation" style="display: block; color: #191E1D; font-size: 0.875rem; font-weight: 500; margin-bottom: 0.5rem; text-align: left;">
                            Повторите пароль
                        </label>
                        <input type="password" 
                    ...
                    <div class="form-group" style="display: flex; justify-content: flex-start; margin-top: 1.5rem;">
                        <button type="submit"
                            ...
                            <span id="resetPasswordBtnText">@lang('messages.auth.change_password')</span>
                            <span id="resetPasswordBtnLoading" style="display: none;" class="flex items-center">
...
<style>
    ...
    body.modal-open-reset-password {
    ...
    #resetPasswordModal[style*="block"] {
    ...
    @media (max-width: 768px) {
        ...
        #resetPasswordModal button[onclick*="closeResetPasswordModal"] {
            position: fixed !important;
            top: 10px !important;
        ...
        #resetPasswordModal > div > div > div > div[style*="padding: 1.5rem"] {
...
<script>
// Reset Password Modal functions - defined in layout head if not already defined
if (typeof window.openResetPasswordModal === 'undefined') {
...
if (typeof window.closeResetPasswordModal === 'undefined') {
...
document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape') {
        if (typeof window.closeResetPasswordModal === 'function') {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resetPasswordForm) {
        resetPasswordForm.addEventListener('submit', function(e) {
            ...
            const btnLoading = document.getElementById('resetPasswordBtnLoading');
