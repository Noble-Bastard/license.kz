...
@section('title')
    @lang('messages.pages.offer.title')
@endsection

@section('content')
    <div class="container mt-5 mb-5 text-justify">
        <h3 class="text-center">Условия обработки персональных данных, агрегируемых через официальные электронные
            ресурсы Upperlicense</h3>
        <p><b>1. Общие положения</b></p>
        <p>Настоящие условие обработки персональных данных составлена в соответствии с требованиями Закона Республики
            Казахстан от 21 мая 2013 года № 94-V «О персональных данных и их защите» и определяет порядок обработки
            персональных данных и меры по обеспечению безопасности персональных данных ТОО «I-license» (далее –
            Оператор).</p>
        ...
        <p>2. Настоящие условие Оператора в отношении обработки персональных данных (далее – Политика) применяется ко
            всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://www.license.kz">https://www.license.kz</a></p>
        ...
        обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://www.license.kz">https://www.license.kz</a>;</p>
        ...
        <p>6. Обработка персональных данных – любое действие (операция) или совокупность действий (операций), совершаемых с
        ...
        Пользователю веб-сайта <a href="https://www.license.kz">https://www.license.kz</a>;</p>
        <p>9. Пользователь – любой посетитель веб-сайта <a href="https://www.license.kz">https://www.license.kz</a>;</p>
        ...
        <p>1. Фамилия, имя, отчество или наименование компании;</p>
        <p>2. БИН;</p>
        <p>3. Электронный адрес;</p>
        <p>4. Номера телефонов;</p>
        <p>5. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с
        помощью сервисов интернет статистики (Яндекс Метрика и Гугл Аналитика и других);</p>
        <p>6. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные данные.</p>

        <p><b>4. Цели обработки персональных данных</b></p>
        <p>1. Цель обработки персональных данных Пользователя — информирование Пользователя посредством отправки
        электронных писем; выполнения обязательств Администрации Сайта перед Пользователями в отношении использования
        ...
        направив Оператору письмо на адрес электронной почты info@license.kz с пометкой «Отказ от уведомлениях о новых
        продуктах и услугах и специальных предложениях»;</p>
        ...
        Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="https://www.license.kz">https://www.license.kz</a>. Заполняя
        ...
        путем направления Оператору уведомление на адрес электронной почты Оператора info@license.kz с пометкой
        ...
        электронный адрес Оператора info@license.kz с пометкой «Отзыв согласия на обработку персональных данных».</p>
        ...
        <p>2. Трансграничная передача персональных данных на территории иностранных государств, не отвечающих вышеуказанным
        ...
        <p>1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных
        данных, обратившись к Оператору с помощью электронной почты info@license.kz, письменной форме по адресу:
        Республика Казахстан, г. Алматы, ул.Инженерная, дом 17, этаж 2.</p>
        <p>2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика
        действует бессрочно до замены ее новой версией.</p>
        <p>3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://www.license.kz">https://www.license.kz</a>.</p>
    </div>
@endsection