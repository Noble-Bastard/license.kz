                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-8">
                        ...
                        <nav class="flex items-center space-x-1">
                            ...
                            <div class="flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors {{ request()->routeIs('Accountant.document_templates') ? 'text-gray-900 bg-gray-50 font-medium' : 'text-gray-600 hover:text-gray-900' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
