    ...
    <div class="services-inline-header-wrapper">
      <div class="services-inline-header d-lg-none">
        ...
        <div class="services-inline-header__actions">
          ...
          <button type="button" class="services-inline-header__icon" data-close-inline-header onclick="if (window.parent !== window && typeof window.parent.closeServicesModal === 'function') { window.parent.closeServicesModal(); } else { var path = window.location.pathname.split('/').filter(function(p){return p.length>0}); var locale = (path.length>0 && ['en','ru','kz'].includes(path[0])) ? path[0] : 'en'; window.location.href = '/' + locale; } return false;">
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (closeBtn) {
        ...
        closeBtn.addEventListener('click', function(e) {
          ...
          // Если открыто в iframe (модальное окно), закрываем модальное окно
          if (window.parent !== window && typeof window.parent.closeServicesModal === 'function') {
            window.parent.closeServicesModal();
            return false;
          }
