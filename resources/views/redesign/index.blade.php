...
@section('title', 'UPPERLICENSE - Главная')
                                    ...
                                    <div class="first__slider__block__green">
                                        ...
                                        <div class="first__slider__items__wrap">
                                            ...
                                            <div class="first__slider__arrows">
                                                <div class="prev"><img src="{{asset('assets/img/icon-left-arrow.svg')}}" alt=""></div>
                                                <div class="next"><img src="{{asset('assets/img/icon-right-arrow.svg')}}" alt=""></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="first__slider__block__bg">
                                        <img src="{{asset('assets/img/image-slider-1.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="first__slider__block">
                                    ...
                                    <div class="first__slider__block__bg">
                                        <img src="{{asset('assets/img/image-slider-2.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="first__slider__block">
                                    ...
                                    <div class="first__slider__block__bg">
                                        <img src="{{asset('assets/img/image-slider-3.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="first__slider__block">
                                    ...
                                    <div class="first__slider__block__bg">
                                        <img src="{{asset('assets/img/image-slider-4.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="second__wrap">
                    <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                        <div class="second__block">
                            <div class="second__block__img">
                                <img src="{{asset('assets/img/Image-Features-01.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                        <div class="second__block">
                            <div class="second__block__img">
                                <img src="{{asset('assets/img/Image-Features-02.png')}}" alt="">
                            </div>
                            <div class="second__block__wrap">
                    ...
                    <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                        <div class="second__block">
                            <div class="second__block__img">
                                <img src="{{asset('assets/img/Image-Features-03.png')}}" alt="">
                            </div>
                            <div class="second__block__wrap">
                    ...
                    <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                        <div class="second__block">
                            <div class="second__block__img">
                                <img src="{{asset('assets/img/Image-Features-04.png')}}" alt="">
                            </div>
                            <div class="second__block__wrap">
                ...
                <a href="{{ route('about') }}" class="second__button">Узнать всё о платформе</a>
            </div>
        </div>
    </div>
    <div class="third">
                ...
                <div class="third__title__wrap">
                    ...
                    <div class="third__arrow">
                        <div class="third__arrow__prev">
                            <img src="{{asset('assets/img/ic-arrow-prev-black.svg')}}" alt="">
                        </div>
                        <div class="third__arrow__next">
                            <img src="{{asset('assets/img/ic-arrow-next-black.svg')}}" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="seventh__list">
                        <div class="seventh__list__gray">
                            ...
                            <ul class="seventh__list__gray__list">
                                <li>
                                    <img src="{{asset('assets/img/ic-chek.svg')}}" alt="">
                ...
                <div class="eighteth__wrap swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide eighteth__slider__item">
                            <img src="{{asset('assets/img/image 48.png')}}" alt="">
                        </div>
                        <div class="swiper-slide eighteth__slider__item">
                            <img src="{{asset('assets/img/image 49.png')}}" alt="">
                        </div>
                        <div class="swiper-slide eighteth__slider__item">
                            <img src="{{asset('assets/img/image 50.png')}}" alt="">
                        </div>
                        <div class="swiper-slide eighteth__slider__item">
                            <img src="{{asset('assets/img/image 53.png')}}" alt="">
                        </div>
                        <div class="swiper-slide eighteth__slider__item">
                            <img src="{{asset('assets/img/image 48.png')}}" alt="">
                        </div>
                ...
                <div class="roadmap">
                    ...
                    <div class="roadmap-cards">
                        <div class="roadmap-card">
                            <img class="roadmap-card-icon" src="{{asset('assets/img/roadmap_1.png')}}" alt="Запуск MVP" />
                            <h4 class="roadmap-card-title">Запуск MVP</h4>
                            <div class="tooltip-container">
                                <img class="roadmap-card-info" src="{{asset('assets/img/info_circle.png')}}" alt="">
                        ...
                        <div class="roadmap-card">
                            <img class="roadmap-card-icon" src="{{asset('assets/img/roadmap_2.png')}}" alt="Расширение перечня услуг" />
                        ...
                        <div class="roadmap-card">
                            <img class="roadmap-card-icon" src="{{asset('assets/img/roadmap_3.png')}}" alt="Упрощенная оплата" />
                        ...
                        <div class="roadmap-card">
                            <img class="roadmap-card-icon" src="{{asset('assets/img/roadmap_4.png')}}" alt="Реферальная система" />
