            ...
            <div class="col-3">
                <div class="header__right">
                    <div class="header__right__tel">
                        ...
                        <a href="#" class="header__right__tel__link" data-bs-target="#consultModal">Заказать звонок</a>
                    </div>
                    @auth
                        <div class="dropdown">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
    ...
    <div class="offcanvas-body">
        ...
        <div class="mobile-menu__contact">
            ...
            <a href="#" class="mobile-menu__callback" data-bs-target="#consultModal">Заказать звонок</a>
        </div>
...
<style>
    #consultModal {
        animation: consultFadeIn 0.3s ease-out;
    }
    ...
    @media (max-width: 576px) {
        #consultModal > div > div {
            max-width: calc(100% - 40px) !important;
        }
        #consultModal > div > div > div > div:last-child {
...
<script>
    // Функции открытия/закрытия модалки обратного звонка
    ...
    window.closeConsultModal = function() {
        ...
        // Удаляем ВСЕ Bootstrap backdrop-ы, которые могли остаться
    ...
    // Перехватываем клики на элементы с data-bs-target="#consultModal"
    document.addEventListener('click', function(e) {
        var el = e.target.closest('[data-bs-target="#consultModal"]');
        if (el) {
            e.preventDefault();
            e.stopImmediatePropagation();
            // Заполняем source_page
