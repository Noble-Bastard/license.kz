...
@push('css')
    ...
    <link rel="stylesheet" href="{{asset('/current/css/about.css')}}">
@endpush
...
@section('content')
                ...
                <ul class="breadscrumb__list">
                    <li>
                        <a href="{{ route('new-index') }}">
                            <img src="{{asset('current/img/ic-home.svg')}}" alt="">
                            Главная
                        </a>
                    </li>
                    <li>
    ...
    <div class="about-us">
                ...
                <div class="row about__second__wrap">
                    <div class="col-md-12 col-12 col-sm-12 col-xs-12 col-xl-4 col-lg-4">
                        <div class="about__second__block about__second__block__first">
                            ...
                            <div class="about__second__block__img">
                                <img src="{{asset('current/img/about__second-1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-md-12 col-12 col-sm-12 col-xs-12 col-xl-4 col-lg-4">
                        <div class="about__second__block about__second__block__second">
                            ...
                            <div class="about__second__block__img">
                                <img src="{{asset('current/img/about__second-2.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-md-12 col-12 col-sm-12 col-xs-12 col-xl-4 col-lg-4">
                        <div class="about__second__block about__second__block__third">
                            ...
                            <div class="about__second__block__img">
                                <img src="{{asset('current/img/about__second-3.png')}}" alt="">
                            </div>
        ...
        <!-- Third Section - What You Will Find -->
                ...
                <div class="row">
                    ...
                    <div class="second__wrap">
                        <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                            <div class="second__block">
                                <div class="second__block__img">
                                    <img src="{{asset('current/img/about-features-01.png')}}" alt="">
                                </div>
                        ...
                        <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                            <div class="second__block">
                                <div class="second__block__img">
                                    <img src="{{asset('current/img/about-features-02.png')}}" alt="">
                                </div>
                                <div class="second__block__wrap">
                        ...
                        <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                            <div class="second__block">
                                <div class="second__block__img">
                                    <img src="{{asset('current/img/about-features-03.png')}}" alt="">
                                </div>
                                <div class="second__block__wrap">
                        ...
                        <div class="col-md-6 col-12 col-sm-12 col-xs-12 col-xl-3 col-lg-3">
                            <div class="second__block">
                                <div class="second__block__img">
                                    <img src="{{asset('current/img/about-features-04.png')}}" alt="">
                                </div>
                                <div class="second__block__wrap">
                    ...
                    <div class="about-us__stats__grid">
                        <div class="about-us__stats__header">
                            <div class="about-us__stats__logo">
                                <img src="{{asset('current/img/logo_white.svg')}}" alt="">
                            </div>
