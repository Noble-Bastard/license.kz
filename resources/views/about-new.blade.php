    ...
    <div class="about-us">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="about-us__hero__content">
                            <h1 class="about-us__hero__title">
                                <span class="text-primary">UPPERLICENSE</span> — инновационная онлайн-платформа,
                                предлагающая комплексные решения для ведения бизнеса в Казахстане
                            </h1>
                            <p class="about-us__hero__description">
                                Мы объединяем передовые технологии и профессиональную экспертизу, чтобы максимально
                                упростить взаимодействие предпринимателей с государственными органами - от регистрации
                                ТОО и открытия банковских счетов до получения лицензий и разрешений.
                            </p>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-us__hero__image-container">
                            <img src="{{asset('images/aboutmain.png')}}"
                                 alt="UPPERLICENSE"
                                 class="about-us__hero__image img-fluid"
                                 onerror="this.onerror=null;this.src='{{ asset('images/aboutmain.png') }}';">

                            <div class="about-us__hero__arrow"></div>
                        </div>
        ...
        <div class="about-us__features">
            <div class="container">
                <div class="about-us__features__header">
                    <h2>С UPPERLICENSE вы <span
                                class="text-primary">легко соберете и оформите все необходимые документы</span> и всегда
                        будете в курсе актуальных изменений законодательства.</h2>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-us__features__card about-us__features__card--white">
                            ...
                            <div class="about-us__features__card__image">
                                <img src="{{ asset('images/Rectangleabout.png') }}" alt="Бесплатный доступ"
                                     class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-us__features__card about-us__features__card--green">
                            ...
                            <div class="about-us__features__card__image">
                                <img src="{{ asset('images/Rectangleabout2.png') }}" alt="Актуальные данные"
                                     class="img-fluid">
                            </div>

                            <p>Оперируйте самыми свежими и достоверными данными о бизнес-процессах, включая открытие
                                ТОО, создание банковских счётов и лицензирование в различных отраслях.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-us__features__card about-us__features__card--beige">
                            ...
                            <div class="about-us__features__card__image">
                                <img src="{{ asset('images/Rectangleabout3.png') }}" alt="Документы в одном месте"
                                     class="img-fluid">
                            </div>

                            <p>Легко и быстро собирайте и оформляйте полные комплекты документов для получения лицензий,
                                разрешений и других бизнес-услуг.</p>
                        </div>
                    </div>
                </div>
                <div class="about-us__mission">
                    <div class="container">
                        <div class="about-us__mission__content">
                            <p><span class="text-primary">Наша миссия</span> — содействовать улучшению деловой среды в
                                Казахстане, предоставляя современные цифровые решения и сервисы для упрощения
                                взаимодействия бизнеса и государства.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-us__find__cards-container">
                <div class="about-us__find__card">
                    ...
                    <div class="about-us__find__card__content">
                        ...
                        <p class="about-us__find__card__description">Больше не нужно тратить время на поиск разрозненной
                            информации - на нашей платформе вся необходимая информация собрана в одном месте, тщательно
                            проверена и всегда актуальна.</p>
                    </div>
                </div>
                <div class="about-us__find__card">
                    <div class="about-us__find__card__image">
                    ...
                    <div class="about-us__find__card__content">
                        ...
                        <p class="about-us__find__card__description">Доверьте сбор документов и отслеживание заявок
                            профессионалам нашей команде, которая оперативно подготовит все необходимые материалы.</p>
                    </div>
                </div>
                <div class="about-us__find__card">
                    <div class="about-us__find__card__image">
                    ...
                    <div class="about-us__find__card__content">
                        ...
                        <p class="about-us__find__card__description">Воспользуйтесь дополнительными сервисами и
                            специальными условиями от наших партнеров для полного соответствия лицензионным
                            требованиям.</p>
                    </div>
                </div>
                <div class="about-us__find__card">
                    ...
                    <div class="about-us__find__card__content">
                        ...
                        <p class="about-us__find__card__description">Смотрите разъясняющие видеоматериалы с пояснениями
                            требований и условий для лицензирования непосредственно от представителей государственных
                            органов.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="services-section">
            <div class="services-section__header">
                <h2>Предоставляем качественные<br>и комплексные <span class="text-primary">решения</span><br>для вашего бизнеса</h2>
            </div>
            <div class="services-section__grid">
                ...
                <div class="service-card service-card--beige">
                    ...
                    <button class="service-card__button">Оформить заявку</button>
        ...
        <div class="about-us__stats">
            <div class="container">
                <div class="about-us__stats__grid">
                    ...
                    <!-- Правая верхняя строка -->
                    <div class="about-us__stats__numbers">
                    ...
                    <div class="about-us__stats__numbers">
                        ...
                        <div class="about-us__stats__item wide">
        ...
        <div class="about-us__cta">
            <div class="container">
                <div class="about-us__cta__wrapper">
                    <!-- Паттерн фоном -->
                    <div class="about-us__cta__pattern">
                        <div class="line"></div>
                        <div class="line"></div>
                        <div class="line"></div>
                        <div class="line"></div>
                    ...
                    <div class="about-us__cta__content">
                        ...
                        <div class="about-us__cta__buttons">
                            <a href="{{route('new-index') . '#listOfIndustries'}}" class="btn btn-green">
                                Стать клиентом
                            </a>
                            <a href="{{route('partners')}}" class="btn btn-light">
                                Стать партнёром
                            </a>
                        </div>
                    </div>
