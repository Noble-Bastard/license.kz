            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => route('admin.workingCalendar.update',$WorkingDay->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                        <input name="id" type="hidden" value="{{$WorkingDay->id}}"/>
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('decsription', $WorkingDay->decsription, array_merge(['class' => $errors->has('decsription') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('start_date', $WorkingDay->start_date, array_merge(['class' => $errors->has('start_date') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus','data-provide'=>'datepicker' ])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('end_date', $WorkingDay->end_date, array_merge(['class' => $errors->has('end_date') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus','data-provide'=>'datepicker'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::select('aps_day_type_id', $dayTypeList, $WorkingDay->aps_day_type_id, array_merge(['placeholder' => '', 'class' => $errors->has('country_id') ? 'form-control is-invalid' : 'form-control'])) !!}
