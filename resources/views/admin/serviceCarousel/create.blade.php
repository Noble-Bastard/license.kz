    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['url' => route('admin.mainServiceCarousel.store'), 'method' => 'post', 'class' => 'form-horizontal','enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                            {!! Form::select('service_category', $serviceCategoryList, null, array_merge(['placeholder' => '', 'class' => $errors->has('service_category') ? 'form-control is-invalid' : 'form-control'])) !!}
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3 service_list">
                            {!! Form::select('service_id', $serviceList, null, array_merge(['placeholder' => '', 'class' => $errors->has('service_id') ? 'form-control is-invalid' : 'form-control'])) !!}
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                            {!! Form::text('order_no', null, array_merge(['class' => $errors->has('order_no') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
