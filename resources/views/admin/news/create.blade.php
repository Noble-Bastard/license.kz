        ...
        <div class="row">
            <div class="col-12">
                <div class="title-main">
                    @lang('messages.admin.news.create_news')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::select('country_id', $countryList, null, array_merge(['placeholder' => '', 'class' => $errors->has('country_id') ? 'form-control is-invalid' : 'form-control'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('header', null, array_merge(['class' => $errors->has('header') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('header_en', null, array_merge(['class' => $errors->has('header') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::textarea('content', null, array_merge(['class' => $errors->has('content') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::textarea('content_en', null, array_merge(['class' => $errors->has('content_en') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-9 col-sm-9 elementinline pb-3">
                                {!! Form::text('orderNum', null, array_merge(['class' => $errors->has('orderNum') ? 'form-control is-invalid' : 'form-control',  'autofocus' => 'autofocus'])) !!}
