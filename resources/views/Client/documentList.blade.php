    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="relative">
            <input type="text" 
                   ...
                   class="w-[28rem] px-4 py-2 pl-16 pr-4 text-gray-500 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                   x-model="searchQuery"
