    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="new_modal_login_main_tab_pane" id="registration-tab-pane" role="tabpanel"
          ...
          @include('current.modal.register_individal')
          @include('current.modal.register_legal', ["isNewProfile" => true,  'autoFocus' => true, "profileLegal" => new \App\Data\Core\Model\ProfileExt()])
